...
const atlas = { tile: 192, cols: 20, rows: 19, index: { '001-rose': 0, '002-x': 21 }, files: { small: '/images/atlas-32.webp', full: '/images/atlas-192.webp' } };
...
describe('computeCloudBounds', () => {
  ...
  it('likeness layout bounds cover only the UMAP positions', () => {
    ...
    // spiralPosition(365) is near (0, 83); a likeness fit must NOT be inflated by it
